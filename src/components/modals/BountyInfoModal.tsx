				...
				<ModalWrapper activeOpacity={1} onPress={() => setModalVisible(false)}>
					<Container activeOpacity={1}>
						...
						<Body style={{ marginVertical: 32 }}>
							A tip is money given to the doctor who answers your question. If
							you set a higher tip amount, you are more likely to get a quick
							response. This is because questions with higher tip amounts are
							given to doctors first.
						</Body>
